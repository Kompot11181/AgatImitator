...
public:
    ...
    SensorSettings(const quint32 num, tSensorType type, const quint8 adr) : SensorSettings(0)
    {
...
//   Коралл  Вибро   КРУ-1      Коралл+                 БКС14                                     БКС16
    {{6, 7}, {7, 1}, {0x7F, 0}, {8, 7}, {0, 0}, {0, 0}, {0xFF, 0xFF}, {0xFF, 0xFF}, {0xFF, 0xFF}, {0xFF, 0x00}, {0xF, 0xF}, {0xF, 0xF}, {0xF, 0xF}, {0, 0}};
// подсказки
...
//КРУ-1В
        {tr("Уровнемер корабельный рефлектометрический «КРУ-1Р» АГТС.407629.002"),
         ...
         tr("Байт статуса (ошибки):\n"
             ...
             "2 - нет ПП;\n"
             "4 - плохая связь с ПП;\n"
             "8 - ошибка по питанию ПП;\n"
             "16 - ошибка по питанию ВП;\n"
             "32 - ошибка поиска импульсов или измерения;\n"
             "64 - не соответствия з/н ПП и ВП;\n"
             "128 - прочие ошибки."),
         tr("не используется"),
        },                    //КРУ-1В
//Коралл+
